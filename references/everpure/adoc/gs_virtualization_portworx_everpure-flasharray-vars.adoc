...
:article-id: suse-virt-portworx-everpure
...
// -
:doctitle: Modern Virtualization with {svirt-long} and {pxe-long}

:docsubtitle: Integrating {pfa-long} with {svirt} for VM storage

:usecase: modern virtualization

:description: Deploy a modern, cloud-native environment supporting container and virtual machine workloads with {svirt-long} and {pxe-long}.

:description-social: Modern Virtualization with {svirt} and {pxe-long}

:executive-summary: Integrate {svirt-brand} with {pxe-brand} to provide a flexible, enterprise platform that enables running both containers and VMs with unparalleled high availability, data protection, hybrid-cloud mobility, and multi-cluster support.
