...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
:ibm-crypto-url: https://www.ibm.com/docs/en/linux-on-systems?topic=execution-crypto-express-adapters#lxse_ap_pass__title__2
...
** One or more {ibm-crypto-url}[supported and properly configured IBM Crypto Express adapters]
//
+
