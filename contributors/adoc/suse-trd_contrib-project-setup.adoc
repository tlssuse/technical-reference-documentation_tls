...
You can use the `refsetup.sh` script to automatically create the required structure along with standard file templates.
...
. Excecute the `refsetup.sh` script located in the `bin` directory.
+
[source, console]
----
./bin/refsetup.sh
...
With your project set up, you can proceed to building your content.
