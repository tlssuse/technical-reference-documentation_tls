...
In fact, you can even define variables using variables you defined earlier (see the `doctitle` variable definition in the previous example).
...
When using the standard templates, you define the document's title and subtitle in the Vars file and reference them in your Main content file as shown below.
