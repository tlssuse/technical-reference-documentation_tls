...
// -
:title: {trd-long} Contributor's Guide

:subtitle: How to contribute to {trd}

:usecase: Documentation

:description: Guidance for contributing to {trd-alt}

:description-social: Contributing {trd-alt}

:executive-summary: Learn how to contribute to {trd-long}, an open collection of high-quality technical guidance for solutions that address real-world use cases with SUSE and third-party technologies.
...
:author1_jobtitle: Ecosystem Solution Innovation Director
:author1_orgname: SUSE
:contrib1_firstname: Bryan
:contrib1_surname: Gartner
:contrib1_jobtitle: Senior Technology Strategist
:contrib1_orgname: SUSE
:contrib2_firstname: Bryan
:contrib2_surname: Gartner
:contrib2_jobtitle: Documentation Strategist
